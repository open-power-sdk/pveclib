...
/** \brief Vector Extract Double Quadword to VSR using GPR-specified Left-Index
 *
 *  See vec_vextdqvlx_PWR8() for description.
 *
 *  \note This variant enables the use of xxperm with access to
 *  all 64 VSRs. See vec_vperm_PWR9().
 *
 *  |processor|Latency|Throughput|
 *  |--------:|:-----:|:---------|
 *  |power7   |   4   | 2/cycle  |
...
/** \brief Vector Extract Double Quadword to VSR using GPR-specified Right-Index
 *
 *  See vec_vextdqvrx_PWR8() for description.
 *
 *  \note This variant enables the use of xxperm with access to
 *  all 64 VSRs. See vec_vperm_PWR9().
 *
 ...
 *
 *  \note The operation generates the raw vperm instruction without any Little Endian transforms.
 *
 *  |processor|Latency|Throughput|
 *  |--------:|:-----:|:---------|
 *  |power7   |   2   | 2/cycle  |
...
/** \brief Vector Permute.
 *
 *  See vec_vperm_PWR8() for description.
 *
 *  \note The operation generates the raw vperm/xxperm instruction
 *  without any Little Endian transforms.
 *  The xxperm instruction can access all 64 VSRs.
 *  This requires -mcpu=power9 and -mvsx,
 *  Otherwise vperm is generated.
 *  The xxperm instruction is a destructive from and may require an
 *  additional xxmr (xxlor) instruction.
 *
 *  |processor|Latency|Throughput|
 *  |--------:|:-----:|:---------|
 *  |power7   |   2   | 2/cycle  |
