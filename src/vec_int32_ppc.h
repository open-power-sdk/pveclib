 ...
 * and multiple high operations.
 *
 * \section i32_endian_issues_0_0 Endian problems with word operations
 *
 * It would be useful to provide a vector multiple high word
 ...
 * Which is some what mitigated by swapping the input arguments in
 ...
 * (Quadword) aligned and and integer multiple of 4 words.
 *
 ...
 * plus 1, than shifts the 33-bit sum right 1-bit.
 ...
 *
 * It turns out the generating the multiplicative inverse can be
